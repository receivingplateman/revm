...
## [9.1.0](https://github.com/receivingplateman/revm/compare/revm-precompile-v9.0.0...revm-precompile-v9.1.0) - 2024-07-16

### Added
- use `kzg-rs` for kzg point evaluation ([#1558](https://github.com/receivingplateman/revm/pull/1558))

### Other
- main CHANGELOG ([#1592](https://github.com/receivingplateman/revm/pull/1592))
