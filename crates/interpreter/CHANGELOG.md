...
## [6.0.1](https://github.com/receivingplateman/revm/compare/revm-interpreter-v6.0.0...revm-interpreter-v6.0.1) - 2024-06-24

### Other
- use const blocks ([#1522](https://github.com/receivingplateman/revm/pull/1522))
- fix compile for alloydb ([#1559](https://github.com/receivingplateman/revm/pull/1559))
- replace AccessList with alloy version ([#1552](https://github.com/receivingplateman/revm/pull/1552))
- replace U256 with u64 in BLOCKHASH ([#1505](https://github.com/receivingplateman/revm/pull/1505))
