...
## [2.0.0](https://github.com/receivingplateman/revm/compare/revm-interpreter-v1.3.0...revm-interpreter-v2.0.0) - 2024-02-02

### Added
- add `BytecodeLocked::original_bytecode` ([#1037](https://github.com/receivingplateman/revm/pull/1037))
...
### Fixed
- *(Interpreter)* is_revert should call is_revert ([#1007](https://github.com/receivingplateman/revm/pull/1007))
...
- expose InstructionResult getters in Interpreter result ([#1002](https://github.com/receivingplateman/revm/pull/1002))
