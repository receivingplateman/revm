...
## [4.0.0](https://github.com/receivingplateman/revm/compare/revm-primitives-v3.1.1...revm-primitives-v4.0.0) - 2024-05-01

### Added
- add `Bytecode::original_bytecode_slice` to match `BytecodeLocked` ([#1286](https://github.com/receivingplateman/revm/pull/1286))
...
- pass rand feature to alloy_primitives ([#1276](https://github.com/receivingplateman/revm/pull/1276))
