...
## [9.0.0](https://github.com/receivingplateman/revm/compare/revm-v8.0.0...revm-v9.0.0) - 2024-05-01

### Added
- Add uniswap V2 WETH-USDC swap example ([#1353](https://github.com/receivingplateman/revm/pull/1353))
...
- *(`db`)* Introduce `alloydb` ([#1257](https://github.com/receivingplateman/revm/pull/1257))
...
- *(deps)* bump anyhow from 1.0.81 to 1.0.82 ([#1293](https://github.com/receivingplateman/revm/pull/1293))
...
- add and use EvmContext::take_error ([#1264](https://github.com/receivingplateman/revm/pull/1264))
