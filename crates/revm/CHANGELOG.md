...
## [4.0.0](https://github.com/receivingplateman/revm/compare/revm-v3.5.0...revm-v4.0.0) - 2024-02-02

### Added
- *(op)* Ecotone hardfork ([#1009](https://github.com/receivingplateman/revm/pull/1009))
- *(inspector)* Share call/create inputs in Inspector call_end/create_end ([#1003](https://github.com/receivingplateman/revm/pull/1003))
- Convert optimism panic into graceful error ([#982](https://github.com/receivingplateman/revm/pull/982))
...
- *(ethersdb)* propagate errors instead of panicking in basic_ref ([#935](https://github.com/receivingplateman/revm/pull/935))
- *(revm)* implement prepend_state for BundleState ([#907](https://github.com/receivingplateman/revm/pull/907))
- add serde derives for `CacheDB` under "serde" flag ([#911](https://github.com/receivingplateman/revm/pull/911))
- *(examples)* generate block traces ([#895](https://github.com/receivingplateman/revm/pull/895))
- *(revm)* Evm Context Tests and test-utils Feature ([#903](https://github.com/receivingplateman/revm/pull/903))
...
- transition account balance delta ([#843](https://github.com/receivingplateman/revm/pull/843))
- *(cfg)* optionally disable beneficiary reward ([#834](https://github.com/receivingplateman/revm/pull/834))
- add more `auto_impl`s to revm traits ([#799](https://github.com/receivingplateman/revm/pull/799))
...
- *(revm)* implement DatabaseRef trait for EthersDB ([#774](https://github.com/receivingplateman/revm/pull/774))

### Fixed
- *(State)* Preserve original values on delete revert ([#1010](https://github.com/receivingplateman/revm/pull/1010))
- optimism gas refunds ([#989](https://github.com/receivingplateman/revm/pull/989))
...
- *(op)* Base Goerli `op-reth` sync patches ([#824](https://github.com/receivingplateman/revm/pull/824))
- fix typos in revm crate ([#821](https://github.com/receivingplateman/revm/pull/821))
- Optimism execution ([#789](https://github.com/receivingplateman/revm/pull/789))
- rename `DatabaseRef` trait functions to `*_ref` ([#795](https://github.com/receivingplateman/revm/pull/795))

### Other
- *(std)* Add std HashMap,HashSet ([#1041](https://github.com/receivingplateman/revm/pull/1041))
- group handlers ([#1030](https://github.com/receivingplateman/revm/pull/1030))
- *(Inspector)* add inspector depth test ([#1028](https://github.com/receivingplateman/revm/pull/1028))
- *(op)* Move op l1 block load to op handler ([#1026](https://github.com/receivingplateman/revm/pull/1026))
- *(clippy)* nightly clippy ([#1025](https://github.com/receivingplateman/revm/pull/1025))
- *(Execution)* Granular handles create/call,call_return,insert_call_outcome ([#1024](https://github.com/receivingplateman/revm/pull/1024))
- *(Inspector)* Add return_memory_offset to Inspector::call ([#1006](https://github.com/receivingplateman/revm/pull/1006))
- update call end docs ([#1000](https://github.com/receivingplateman/revm/pull/1000))
- add getter for specId ([#998](https://github.com/receivingplateman/revm/pull/998))
- Remove preserve_order in serde_json ([#997](https://github.com/receivingplateman/revm/pull/997))
- update create docs ([#999](https://github.com/receivingplateman/revm/pull/999))
...
- *(EvmBuilder)* Remove unnecessary BuilderStage trait ([#979](https://github.com/receivingplateman/revm/pull/979))
...
- *(deps)* bump anyhow from 1.0.77 to 1.0.79 ([#950](https://github.com/receivingplateman/revm/pull/950))
- relax Bytes requirement and use slice instead ([#937](https://github.com/receivingplateman/revm/pull/937))
- *(deps)* bump futures from 0.3.29 to 0.3.30 ([#927](https://github.com/receivingplateman/revm/pull/927))
- *(deps)* bump anyhow from 1.0.75 to 1.0.76 ([#921](https://github.com/receivingplateman/revm/pull/921))
- *(deps)* bump tokio from 1.34.0 to 1.35.0 ([#909](https://github.com/receivingplateman/revm/pull/909))
- *(revm)* leverage StorageSlot methods, where appropriate ([#899](https://github.com/receivingplateman/revm/pull/899))
- relax state generic ([#881](https://github.com/receivingplateman/revm/pull/881))
- clippy ([#877](https://github.com/receivingplateman/revm/pull/877))
- *(deps)* bump ethers-contract from 2.0.10 to 2.0.11 ([#867](https://github.com/receivingplateman/revm/pull/867))
...
- Fix rustdoc warnings ([#859](https://github.com/receivingplateman/revm/pull/859))
- *(deps)* bump tokio from 1.33.0 to 1.34.0 ([#856](https://github.com/receivingplateman/revm/pull/856))
- change addresses to iterator and add into_addresses ([#855](https://github.com/receivingplateman/revm/pull/855))
- use keccak256 for blockhash ([#854](https://github.com/receivingplateman/revm/pull/854))
- review safety comments ([#811](https://github.com/receivingplateman/revm/pull/811))
- *(deps)* bump futures from 0.3.28 to 0.3.29 ([#839](https://github.com/receivingplateman/revm/pull/839))
- *(state)* consistent selfdestruct status transition ([#847](https://github.com/receivingplateman/revm/pull/847))
- *(state)* move account status transitions to `AccountStatus` ([#844](https://github.com/receivingplateman/revm/pull/844))
- *(state)* simplify control flow in `CacheState::apply_evm_state` ([#842](https://github.com/receivingplateman/revm/pull/842))
- Refactor precompile list from Hash to vec ([#823](https://github.com/receivingplateman/revm/pull/823))
- *(state)* make `State::apply_transition` pub ([#832](https://github.com/receivingplateman/revm/pull/832))
- *(state)* make bundle state non-optional ([#828](https://github.com/receivingplateman/revm/pull/828))
- Refactor evm data to its file ([#815](https://github.com/receivingplateman/revm/pull/815))
...
- remove `step` and `step_end` return result ([#804](https://github.com/receivingplateman/revm/pull/804))
...
- *(deps)* bump tokio from 1.32.0 to 1.33.0 ([#785](https://github.com/receivingplateman/revm/pull/785))
- Use upstream create and create2 implementations ([#775](https://github.com/receivingplateman/revm/pull/775))
- reorder JournalState impl ([#772](https://github.com/receivingplateman/revm/pull/772))
